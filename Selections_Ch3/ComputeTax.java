...
public class ComputeTax {
    public static void main(String[] args){
        ...
        "qualifying widoer(er), 2-married separately, 3 head of " + 
        ...
        if (status == 0){
            if (income <= 8350){
                ...
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * .25 + (income - 82250) * .28;
            }else if (income <= 372950){
                tax = 8350 * .10 + (33950 - 8350) * .15 + (82250 - 33950) * .25 + ( 171550 - 82250) * .28 + (income - 171550) * .33;
            }else
                tax = 8350 * .10 + (33950 - 8350) * .15 + (82250 - 33950) * .25 + ( 171550 - 82250) * .28 + (372950 - 171550) * .33
                + (income - 372950) * .35;
        }
        else if (status == 1){
            if (income <= 16700){
                ...
                tax = 16700 * .10 + (67900 - 16700) * .15 + (137050 - 67900) * .25 + (208850 - 137050) * .28 + (372950 - 208850) * .33
                + (income - 372950) * .35;
        }
        else if (status == 2){
            if(income <= 8350){
                ...
                tax = 8350 * .10 + (33950 - 8350) * .15 + (68525 - 33950) * .25 + (104425 - 68525) * .28 + (186475- 104425) * .33
                + (income - 186475) * .35;
        }
        else if (status == 3){
            if(income <= 11950){
                ...
                tax = 11950 * .10 + ( 45500 -11950) * .15 + (117450 - 45500) * .25 + (income - 117500) * .28;
            }else if(income <= 372950){
                tax = 11950 * .10 + ( 45500 -11950) * .15 + (117450 - 45500) * .25 + (190200 - 117500) * .28 + (income - 190200) * .33;
            }else   
                tax = 11950 * .10 + ( 45500 -11950) * .15 + (117450 - 45500) * .25 + (190200 - 117500) * .28 + (372950 - 190200) * .33 
                + (income - 372950) * .35;
        }
        else{
